...
export async function GET(request: Request) {
  try {
    ...
    const res = await fetch(
      `https://${domain}/v22.0/${ig_user_id}/media?fields=id,media_type,caption,insights.metric(impressions,engagement,likes,comments,shares,saves)&limit=100&access_token=${access_token}`
    );
